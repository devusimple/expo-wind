...
Tailwind CSS v4 uses `--color-` prefixed variables for theme colors:
...
The utility classes remain the same (`bg-background`, `bg-primary`, etc.) — only the CSS variable names and values change.
